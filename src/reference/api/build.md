...
| [Agent Components · Create an Avatar and an Agent](/reference/api/build/avatar-and-agent/) | Create an Avatar, Create an Agent |

Lifecycle (event-driven rules) has its own doc: **[Lifecycle Rules](/reference/lifecycle/)**.
