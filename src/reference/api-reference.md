...
layout: base.njk
title: "API Reference"
description: "Documents every Kaltura Agentic Avatars API endpoint, the full agent lifecycle, and a verified use-case catalog."
eyebrow: Reference
---
...
To embed a live avatar in a browser, go to [Phase 3 — Deploy](#phase-3--deploy) or jump straight to [UC-12 Anonymous End-User Embed](/reference/use-cases/).
