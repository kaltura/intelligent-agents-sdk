...
**On this page:** [Provenance / components](#provenance--components) · [1. Channels at a glance](#1-channels-at-a-glance) · [2. Socket.IO connection](#2-socketio-connection) · [3. Connect sequence (state-machine order)](#3-connect-sequence-state-machine-order) · [Related docs](#related-docs)
