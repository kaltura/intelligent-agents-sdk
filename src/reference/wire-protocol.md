...
This is the deep reference behind [Platform Overview](/explanation/architecture/) → "Video Runtime Protocol". Read ARCHITECTURE.md first for the big picture. Come back to the pages below when you need an exact event field, the exact ICE config, or the exact order events fire.
