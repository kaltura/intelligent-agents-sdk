 ...
 * them BEFORE the network call. The server overwrites all nine `sys__*`
...
export const RESERVED_VARS = Object.freeze([
  ...
  'sys__ks', 'sys__is_new_thread', 'sys__context_id', 'sys__context_type',
  'sys__avatar_enabled', 'secrets',
]);
