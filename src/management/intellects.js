...
export class Intellects {
   ...
   * @returns {Promise<{text:string, skippedKeys:string[], usedDefaultDirective:boolean, unresolvedVariables:string[], _meta:{renderer:string, rendererBasis:string}&object}>}
   */
