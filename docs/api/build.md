...
| Doc | Covers |
|---|---|
| [`build/intellect.md`](build/intellect.md) | Create an Intellect, Configure an Intellect (prompts, `base_directive`, model, opening phrase, thread-start tools, session summary, capabilities table) |
