...
[KAVA analytics](../README.md#kava-analytics-opt-in-client-only-application-events) section) and
...
[STRUCTURED-DATA-FORMS.md](STRUCTURED-DATA-FORMS.md) for where that data durably belongs instead).
