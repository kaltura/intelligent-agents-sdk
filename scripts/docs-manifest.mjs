...
//
// `group` is the nav.js sidebar section (Diátaxis quadrant); omit it to keep
// a page out of the sidebar entirely. A page omits `group` when it's a split-
// out fragment of a bigger topic with no scope of its own — it's reached via
// its hub page's own link table, not the sidebar. This covers the sub-pages
// under genui/architecture-reference/wire-protocol/api/build, and also the
// six api/*.md pages (authentication, design, build, deploy, operate,
// management-operations): each is one phase/piece of "Backend API Reference"
// (the hub, which keeps its own sidebar entry), not a topic in its own right.
// Lifecycle and Use-Case Catalog are also linked from that hub's own Contents
// table, but they stay sidebar-visible on purpose — each is a real, coherent
// feature someone looks up on its own terms, not a fragment of the API listing.
//
...
export const manifest = [
  ...
  // ---- How-to Guides ----
  {
    ...
    h1: 'Start the Conversation: scripted opening, or silent opening plus kickoff',
    group: 'How-to Guides',
  ...
  },
  {
    ...
    eyebrow: 'Reference',
    h1: 'Backend API Reference — Kaltura Agentic Avatars',
    group: 'Reference',
    navTitle: 'Backend API Reference',
    generated: true,
  },
  {
  ...
  },
  {
    ...
    eyebrow: 'Reference',
    h1: 'Lifecycle Rules — Event-Driven Rules',
    group: 'Reference',
    navTitle: 'Lifecycle Rules',
    generated: true,
  },
  {
    ...
    eyebrow: 'Reference',
    h1: 'Minimal Reimplementation Recipe (No Kaltura Libs)',
    group: 'Reference',
    navTitle: 'Minimal Reimplementation Recipe',
    generated: true,
  },
  {
    ...
    eyebrow: 'Reference',
    h1: 'System Internals Reference',
    group: 'Reference',
    navTitle: 'System Internals Reference',
    generated: true,
  },
  {
  ...
  // ---- api/build/* sub-pages (reached via the "Agent Components" hub page) ----
  {
