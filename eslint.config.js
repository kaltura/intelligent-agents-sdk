...
export default [
  ...
  },
  {
    ...
    files: ['scripts/live-verify-session-complete.mjs', 'scripts/verify-noise-suppressor.mjs', 'scripts/verify-avatar-media.mjs', 'scripts/live-verify-browser.mjs', 'scripts/live-verify-avatar-media.mjs'],
    languageOptions: {
      ecmaVersion: 2024,
      sourceType: 'module',
      globals: browserGlobals,
