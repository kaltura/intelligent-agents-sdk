...
<script type="module">
  ...
  import { KalturaAvatarSession } from 'https://cdn.jsdelivr.net/gh/kaltura/intelligent-agents-sdk@v1.5.0/src/experience/index.js';
  // ... same API as the local examples — see examples/browser-experience.html
</script>
```

Pin the tag (`@v1.5.0`, or whatever release you want) for anything you ship — jsDelivr caches a
...
```bash
node tools/sri-map.mjs --entry src/experience/index.js --tag v1.5.0
```
...
{
  "integrity": {
    "https://cdn.jsdelivr.net/gh/kaltura/intelligent-agents-sdk@v1.5.0/src/experience/index.js": "sha384-T+W7ayOfRNUbRCROS0T4isj2NsGsdiNr5ODeqPnfjlJ4VX3bcxBqnMlMO61qlNZV",
    "https://cdn.jsdelivr.net/gh/kaltura/intelligent-agents-sdk@v1.5.0/src/experience/session.js": "sha384-…",
    "https://cdn.jsdelivr.net/gh/kaltura/intelligent-agents-sdk@v1.5.0/src/core/safety.js": "sha384-…"
